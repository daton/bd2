    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Buscar Todos los almacenes</h1>

                        <table class="table table-dark">
                            <thead>
                                <tr>
                                    <th scope="col">Numero de almacen</th>
                                    <th scope="col">Ubicacion del almacen</th>
        ...
        <script>
             $.ajax('http://localhost:8084/base-datos/buscar-todos-almacen', {
                    type: 'get',
                    dataType:'json',
                    success: function (datos) {
                        console.log(datos[0].ubicacion_almacen)
                        for(var i=0;i<datos.length;i++){
                           $("#tabla").append('<tr><td>'+datos[i].numero_almacen+'</td><td>'+datos[i].ubicacion_almacen+'</td></tr>')
                        }
                    }
                })
